...
struct WelcomeView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            .background {
                LottieView(animation: try! .from(data: animationData))
                    .playing(loopMode: .loop)
                    .resizable()
                    .aspectRatio(contentMode: .fill)
                    .colorInvert() // <-- turns black into white
                    .colorMultiply(.welcomeColorMain) // white * color = color
